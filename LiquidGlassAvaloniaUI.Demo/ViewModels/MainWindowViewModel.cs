...
namespace AvaloniaApplication1.ViewModels
{
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        public bool UseWallpaperBackground
        {
            get => BackgroundIndex == 0;
        }
        public bool UsePhotoBackground
        {
            get => BackgroundIndex == 1;
        }
        public bool UseDistortionBackground
        {
            get => BackgroundIndex == 2;
        }
        ...
        {
            get => new(BackdropOffsetX, BackdropOffsetY);
        }
        ...
        {
            get => new(ShadowOffsetX, ShadowOffsetY);
        }
        ...
        {
            get => new(InnerShadowOffsetX, InnerShadowOffsetY);
        }
        ...
        {
            get => EnableTint ? TintPresets[Math.Clamp(TintPresetIndex, 0, TintPresets.Length - 1)] : Colors.Transparent;
        }
        ...
        {
            get => EnableSurface ? SurfacePresets[Math.Clamp(SurfacePresetIndex, 0, SurfacePresets.Length - 1)] : Colors.Transparent;
        }
        ...
        {
            Colors.White, Color.FromRgb(128, 128, 128)
        };
